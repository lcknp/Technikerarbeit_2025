...
const tempInnen1Series  = createTimeSeriesChart("tempInnen1Chart");
const tempAussen1Series = createTimeSeriesChart("tempAussen1Chart");
const tempInnen2Series  = createTimeSeriesChart("tempInnen2Chart");
const tempAussen2Series = createTimeSeriesChart("tempAussen2Chart");
...
const allSeries = [
  co2Series,
  tempInnen1Series, tempAussen1Series,
  tempInnen2Series, tempAussen2Series,
  pwm1Series, pwm2Series
];
...
async function refresh() {
  ...
  pushPoint(tempInnen1Series,  j.ts, j.tempinnen1,  ONE_HOUR);
  pushPoint(tempAussen1Series, j.ts, j.tempaussen1, ONE_HOUR);
  pushPoint(tempInnen2Series,  j.ts, j.tempinnen2,  ONE_HOUR);
  pushPoint(tempAussen2Series, j.ts, j.tempaussen2, ONE_HOUR);
